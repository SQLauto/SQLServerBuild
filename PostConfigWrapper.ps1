...
# Run all SQL files
# Invoke-DbaSqlCmd -SqlServer $SqlServer -File ($files) ## If i didnt have GO in half of the scripts i would use this format! sadly i do so needed to create something myself
Invoke-SQLScripts -Path $filePath -Recurse
